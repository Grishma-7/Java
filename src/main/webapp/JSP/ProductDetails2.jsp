...
<div class="container">
    <div class="product-image">
        <img src="../image/untitled_design_47_.png" alt="HP">
    </div>

    <div class="product-details">
        <h1>Lenovo IdeaPad 3</h1>
        <p class="price">Rs.66,497</p>
        <p class="description">
            (IdeaPad Gaming 3i (Intel)165Hz 15.6″ IPS| Core i7-12700H |RTX 3060 (105W)| 16GB DDR4| 512GB SSD| 60Whr Battery).
        </p>
